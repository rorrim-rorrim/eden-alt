...
template <>
void EmitIR<IR::Opcode::VectorArithmeticShiftRight16>(biscuit::Assembler&, EmitContext&,
                                                      IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorArithmeticShiftRight32>(biscuit::Assembler&, EmitContext&,
                                                      IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorArithmeticShiftRight64>(biscuit::Assembler&, EmitContext&,
                                                      IR::Inst*) {
    UNIMPLEMENTED();
}
...
template <>
void EmitIR<IR::Opcode::VectorBroadcastElementLower8>(biscuit::Assembler&, EmitContext&,
                                                      IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorBroadcastElementLower16>(biscuit::Assembler&, EmitContext&,
                                                       IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorBroadcastElementLower32>(biscuit::Assembler&, EmitContext&,
                                                       IR::Inst*) {
    UNIMPLEMENTED();
}
...
template <>
void EmitIR<IR::Opcode::VectorDeinterleaveEvenLower8>(biscuit::Assembler&, EmitContext&,
                                                      IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorDeinterleaveEvenLower16>(biscuit::Assembler&, EmitContext&,
                                                       IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorDeinterleaveEvenLower32>(biscuit::Assembler&, EmitContext&,
                                                       IR::Inst*) {
    UNIMPLEMENTED();
}
...
template <>
void EmitIR<IR::Opcode::VectorDeinterleaveOddLower16>(biscuit::Assembler&, EmitContext&,
                                                      IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorDeinterleaveOddLower32>(biscuit::Assembler&, EmitContext&,
                                                      IR::Inst*) {
    UNIMPLEMENTED();
}
...
template <>
void EmitIR<IR::Opcode::VectorMultiplyUnsignedWiden8>(biscuit::Assembler&, EmitContext&,
                                                      IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorMultiplyUnsignedWiden16>(biscuit::Assembler&, EmitContext&,
                                                       IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorMultiplyUnsignedWiden32>(biscuit::Assembler&, EmitContext&,
                                                       IR::Inst*) {
    UNIMPLEMENTED();
}
...
template <>
void EmitIR<IR::Opcode::VectorPairedAddSignedWiden16>(biscuit::Assembler&, EmitContext&,
                                                      IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorPairedAddSignedWiden32>(biscuit::Assembler&, EmitContext&,
                                                      IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorPairedAddUnsignedWiden8>(biscuit::Assembler&, EmitContext&,
                                                       IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorPairedAddUnsignedWiden16>(biscuit::Assembler&, EmitContext&,
                                                        IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorPairedAddUnsignedWiden32>(biscuit::Assembler&, EmitContext&,
                                                        IR::Inst*) {
    UNIMPLEMENTED();
}
...
template <>
void EmitIR<IR::Opcode::VectorPolynomialMultiplyLong8>(biscuit::Assembler&, EmitContext&,
                                                       IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorPolynomialMultiplyLong64>(biscuit::Assembler&, EmitContext&,
                                                        IR::Inst*) {
    UNIMPLEMENTED();
}
...
template <>
void EmitIR<IR::Opcode::VectorReverseElementsInHalfGroups8>(biscuit::Assembler&, EmitContext&,
                                                            IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorReverseElementsInWordGroups8>(biscuit::Assembler&, EmitContext&,
                                                            IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorReverseElementsInWordGroups16>(biscuit::Assembler&, EmitContext&,
                                                             IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorReverseElementsInLongGroups8>(biscuit::Assembler&, EmitContext&,
                                                            IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorReverseElementsInLongGroups16>(biscuit::Assembler&, EmitContext&,
                                                             IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorReverseElementsInLongGroups32>(biscuit::Assembler&, EmitContext&,
                                                             IR::Inst*) {
    UNIMPLEMENTED();
}
...
template <>
void EmitIR<IR::Opcode::VectorRotateWholeVectorRight>(biscuit::Assembler&, EmitContext&,
                                                      IR::Inst*) {
    UNIMPLEMENTED();
}
...
template <>
void EmitIR<IR::Opcode::VectorSignedAbsoluteDifference8>(biscuit::Assembler&, EmitContext&,
                                                         IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorSignedAbsoluteDifference16>(biscuit::Assembler&, EmitContext&,
                                                          IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorSignedAbsoluteDifference32>(biscuit::Assembler&, EmitContext&,
                                                          IR::Inst*) {
    UNIMPLEMENTED();
}
...
template <>
void EmitIR<IR::Opcode::VectorSignedSaturatedAccumulateUnsigned8>(biscuit::Assembler&, EmitContext&,
                                                                  IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorSignedSaturatedAccumulateUnsigned16>(biscuit::Assembler&,
                                                                   EmitContext&, IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorSignedSaturatedAccumulateUnsigned32>(biscuit::Assembler&,
                                                                   EmitContext&, IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorSignedSaturatedAccumulateUnsigned64>(biscuit::Assembler&,
                                                                   EmitContext&, IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorSignedSaturatedDoublingMultiplyHigh16>(biscuit::Assembler&,
                                                                     EmitContext&, IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorSignedSaturatedDoublingMultiplyHigh32>(biscuit::Assembler&,
                                                                     EmitContext&, IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorSignedSaturatedDoublingMultiplyHighRounding16>(biscuit::Assembler&,
                                                                             EmitContext&,
                                                                             IR::Inst*) {
    UNIMPLEMENTED();
}
...
template <>
void EmitIR<IR::Opcode::VectorSignedSaturatedDoublingMultiplyHighRounding32>(biscuit::Assembler&,
                                                                             EmitContext&,
                                                                             IR::Inst*) {
    UNIMPLEMENTED();
}
...
template <>
void EmitIR<IR::Opcode::VectorSignedSaturatedDoublingMultiplyLong16>(biscuit::Assembler&,
                                                                     EmitContext&, IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorSignedSaturatedDoublingMultiplyLong32>(biscuit::Assembler&,
                                                                     EmitContext&, IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorSignedSaturatedNarrowToSigned16>(biscuit::Assembler&, EmitContext&,
                                                               IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorSignedSaturatedNarrowToSigned32>(biscuit::Assembler&, EmitContext&,
                                                               IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorSignedSaturatedNarrowToSigned64>(biscuit::Assembler&, EmitContext&,
                                                               IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorSignedSaturatedNarrowToUnsigned16>(biscuit::Assembler&, EmitContext&,
                                                                 IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorSignedSaturatedNarrowToUnsigned32>(biscuit::Assembler&, EmitContext&,
                                                                 IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorSignedSaturatedNarrowToUnsigned64>(biscuit::Assembler&, EmitContext&,
                                                                 IR::Inst*) {
    UNIMPLEMENTED();
}
...
template <>
void EmitIR<IR::Opcode::VectorSignedSaturatedShiftLeft8>(biscuit::Assembler&, EmitContext&,
                                                         IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorSignedSaturatedShiftLeft16>(biscuit::Assembler&, EmitContext&,
                                                          IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorSignedSaturatedShiftLeft32>(biscuit::Assembler&, EmitContext&,
                                                          IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorSignedSaturatedShiftLeft64>(biscuit::Assembler&, EmitContext&,
                                                          IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorSignedSaturatedShiftLeftUnsigned8>(biscuit::Assembler&, EmitContext&,
                                                                 IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorSignedSaturatedShiftLeftUnsigned16>(biscuit::Assembler&, EmitContext&,
                                                                  IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorSignedSaturatedShiftLeftUnsigned32>(biscuit::Assembler&, EmitContext&,
                                                                  IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorSignedSaturatedShiftLeftUnsigned64>(biscuit::Assembler&, EmitContext&,
                                                                  IR::Inst*) {
    UNIMPLEMENTED();
}
...
template <>
void EmitIR<IR::Opcode::VectorUnsignedAbsoluteDifference8>(biscuit::Assembler&, EmitContext&,
                                                           IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorUnsignedAbsoluteDifference16>(biscuit::Assembler&, EmitContext&,
                                                            IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorUnsignedAbsoluteDifference32>(biscuit::Assembler&, EmitContext&,
                                                            IR::Inst*) {
    UNIMPLEMENTED();
}
...
template <>
void EmitIR<IR::Opcode::VectorUnsignedRecipSqrtEstimate>(biscuit::Assembler&, EmitContext&,
                                                         IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorUnsignedSaturatedAccumulateSigned8>(biscuit::Assembler&, EmitContext&,
                                                                  IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorUnsignedSaturatedAccumulateSigned16>(biscuit::Assembler&,
                                                                   EmitContext&, IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorUnsignedSaturatedAccumulateSigned32>(biscuit::Assembler&,
                                                                   EmitContext&, IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorUnsignedSaturatedAccumulateSigned64>(biscuit::Assembler&,
                                                                   EmitContext&, IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorUnsignedSaturatedNarrow16>(biscuit::Assembler&, EmitContext&,
                                                         IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorUnsignedSaturatedNarrow32>(biscuit::Assembler&, EmitContext&,
                                                         IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorUnsignedSaturatedNarrow64>(biscuit::Assembler&, EmitContext&,
                                                         IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorUnsignedSaturatedShiftLeft8>(biscuit::Assembler&, EmitContext&,
                                                           IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorUnsignedSaturatedShiftLeft16>(biscuit::Assembler&, EmitContext&,
                                                            IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorUnsignedSaturatedShiftLeft32>(biscuit::Assembler&, EmitContext&,
                                                            IR::Inst*) {
    UNIMPLEMENTED();
}

template <>
void EmitIR<IR::Opcode::VectorUnsignedSaturatedShiftLeft64>(biscuit::Assembler&, EmitContext&,
                                                            IR::Inst*) {
    UNIMPLEMENTED();
}
