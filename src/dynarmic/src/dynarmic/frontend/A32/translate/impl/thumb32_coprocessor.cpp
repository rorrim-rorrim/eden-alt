...
bool TranslatorVisitor::thumb32_MCRR(bool two, Reg t2, Reg t, size_t coproc_no, size_t opc,
                                     CoprocReg CRm) {
    ir.CoprocSendTwoWords(coproc_no, two, opc, CRm, ir.GetRegister(t), ir.GetRegister(t2));
    return true;
}

bool TranslatorVisitor::thumb32_MRRC(bool two, Reg t2, Reg t, size_t coproc_no, size_t opc,
                                     CoprocReg CRm) {
...
bool TranslatorVisitor::thumb32_STC(bool two, bool p, bool u, bool d, bool w, Reg n, CoprocReg CRd,
...
bool TranslatorVisitor::thumb32_LDC(bool two, bool p, bool u, bool d, bool w, Reg n, CoprocReg CRd,
                                    size_t coproc_no, Imm<8> imm8) {
    const u32 imm32 = imm8.ZeroExtend() << 2;
    const bool index = p;
    const bool add = u;
...
bool TranslatorVisitor::thumb32_CDP(bool two, size_t opc1, CoprocReg CRn, CoprocReg CRd,
                                    size_t coproc_no, size_t opc2, CoprocReg CRm) {
    ir.CoprocInternalOperation(coproc_no, two, opc1, CRd, CRn, CRm, opc2);
    return true;
}

bool TranslatorVisitor::thumb32_MCR(bool two, size_t opc1, CoprocReg CRn, Reg t, size_t coproc_no,
                                    size_t opc2, CoprocReg CRm) {
    ir.CoprocSendOneWord(coproc_no, two, opc1, CRn, CRm, opc2, ir.GetRegister(t));
    return true;
}

bool TranslatorVisitor::thumb32_MRC(bool two, size_t opc1, CoprocReg CRn, Reg t, size_t coproc_no,
                                    size_t opc2, CoprocReg CRm) {
