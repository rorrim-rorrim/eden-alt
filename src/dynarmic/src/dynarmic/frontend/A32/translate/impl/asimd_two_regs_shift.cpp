...
namespace {
enum class Accumulating { None, Accumulate };
...
IR::U128 PerformRoundingATRSCorrection(TranslatorVisitor& v, size_t esize, u64 round_value,
                                       IR::U128 original, IR::U128 shifted) {
    const auto round_const = v.ir.VectorBroadcast(esize, v.I(esize, round_value));
    const auto round_correction =
        v.ir.VectorEqual(esize, v.ir.VectorAnd(original, round_const), round_const);
...
bool ShiftRight(TranslatorVisitor& v, bool U, bool D, size_t imm6, size_t Vd, bool L, bool Q,
                bool M, size_t Vm, Accumulating accumulate, RoundingATRS RoundingATRS) {
...
bool ShiftRightNarrowing(TranslatorVisitor& v, bool D, size_t imm6, size_t Vd, bool M, size_t Vm,
                         RoundingATRS RoundingATRS, Narrowing narrowing, Signedness signedness) {
    ...
    if (RoundingATRS == RoundingATRS::Round) {
        const u64 round_value = 1ULL << (shift_amount - 1);
        wide_result =
            PerformRoundingATRSCorrection(v, source_esize, round_value, reg_m, wide_result);
    }
...
bool TranslatorVisitor::asimd_SHR(bool U, bool D, size_t imm6, size_t Vd, bool L, bool Q, bool M,
                                  size_t Vm) {
    return ShiftRight(*this, U, D, imm6, Vd, L, Q, M, Vm, Accumulating::None, RoundingATRS::None);
}

bool TranslatorVisitor::asimd_SRA(bool U, bool D, size_t imm6, size_t Vd, bool L, bool Q, bool M,
                                  size_t Vm) {
    return ShiftRight(*this, U, D, imm6, Vd, L, Q, M, Vm, Accumulating::Accumulate,
                      RoundingATRS::None);
}

bool TranslatorVisitor::asimd_VRSHR(bool U, bool D, size_t imm6, size_t Vd, bool L, bool Q, bool M,
                                    size_t Vm) {
    return ShiftRight(*this, U, D, imm6, Vd, L, Q, M, Vm, Accumulating::None, RoundingATRS::Round);
}

bool TranslatorVisitor::asimd_VRSRA(bool U, bool D, size_t imm6, size_t Vd, bool L, bool Q, bool M,
                                    size_t Vm) {
    return ShiftRight(*this, U, D, imm6, Vd, L, Q, M, Vm, Accumulating::Accumulate,
                      RoundingATRS::Round);
}

bool TranslatorVisitor::asimd_VSRI(bool D, size_t imm6, size_t Vd, bool L, bool Q, bool M,
                                   size_t Vm) {
    if (!L && mcl::bit::get_bits<3, 5>(imm6) == 0) {
        return DecodeError();
    }
...
bool TranslatorVisitor::asimd_VSLI(bool D, size_t imm6, size_t Vd, bool L, bool Q, bool M,
                                   size_t Vm) {
    if (!L && mcl::bit::get_bits<3, 5>(imm6) == 0) {
        return DecodeError();
    }
...
bool TranslatorVisitor::asimd_VQSHL(bool U, bool D, size_t imm6, size_t Vd, bool op, bool L, bool Q,
                                    bool M, size_t Vm) {
    if (!L && mcl::bit::get_bits<3, 5>(imm6) == 0) {
        return DecodeError();
    }
    ...
    const auto result = [&] {
        ...
        if (U) {
            ...
            return ir.VectorSignedSaturatedShiftLeftUnsigned(esize, reg_m,
                                                             static_cast<u8>(shift_amount));
        }
        if (op) {
...
bool TranslatorVisitor::asimd_VSHL(bool D, size_t imm6, size_t Vd, bool L, bool Q, bool M,
                                   size_t Vm) {
    if (!L && mcl::bit::get_bits<3, 5>(imm6) == 0) {
        return DecodeError();
    }
...
bool TranslatorVisitor::asimd_VSHRN(bool D, size_t imm6, size_t Vd, bool M, size_t Vm) {
    return ShiftRightNarrowing(*this, D, imm6, Vd, M, Vm, RoundingATRS::None, Narrowing::Truncation,
                               Signedness::Unsigned);
}

bool TranslatorVisitor::asimd_VRSHRN(bool D, size_t imm6, size_t Vd, bool M, size_t Vm) {
    return ShiftRightNarrowing(*this, D, imm6, Vd, M, Vm, RoundingATRS::Round,
                               Narrowing::Truncation, Signedness::Unsigned);
}

bool TranslatorVisitor::asimd_VQRSHRUN(bool D, size_t imm6, size_t Vd, bool M, size_t Vm) {
    return ShiftRightNarrowing(*this, D, imm6, Vd, M, Vm, RoundingATRS::Round,
                               Narrowing::SaturateToUnsigned, Signedness::Signed);
}

bool TranslatorVisitor::asimd_VQSHRUN(bool D, size_t imm6, size_t Vd, bool M, size_t Vm) {
    return ShiftRightNarrowing(*this, D, imm6, Vd, M, Vm, RoundingATRS::None,
                               Narrowing::SaturateToUnsigned, Signedness::Signed);
}

bool TranslatorVisitor::asimd_VQSHRN(bool U, bool D, size_t imm6, size_t Vd, bool M, size_t Vm) {
    return ShiftRightNarrowing(*this, D, imm6, Vd, M, Vm, RoundingATRS::None,
                               U ? Narrowing::SaturateToUnsigned : Narrowing::SaturateToSigned,
                               U ? Signedness::Unsigned : Signedness::Signed);
}
...
bool TranslatorVisitor::asimd_VSHLL(bool U, bool D, size_t imm6, size_t Vd, bool M, size_t Vm) {
    ...
    const auto result =
        ir.VectorLogicalShiftLeft(esize * 2, ext_vec, static_cast<u8>(shift_amount));

    ir.SetVector(d, result);
    return true;
}

bool TranslatorVisitor::asimd_VCVT_fixed(bool U, bool D, size_t imm6, size_t Vd, bool to_fixed,
    ...
    const auto result =
        to_fixed
            ? (U ? ir.FPVectorToUnsignedFixed(32, reg_m, fbits, FP::RoundingMode::TowardsZero,
                                              false)
                 : ir.FPVectorToSignedFixed(32, reg_m, fbits, FP::RoundingMode::TowardsZero, false))
            : (U ? ir.FPVectorFromUnsignedFixed(32, reg_m, fbits,
                                                FP::RoundingMode::ToNearest_TieEven, false)
                 : ir.FPVectorFromSignedFixed(32, reg_m, fbits, FP::RoundingMode::ToNearest_TieEven,
                                              false));
