...
TEST_CASE("thumb: Opt Failure: Get/Set Elimination for Flags", "[thumb]") {
    ...
    // [00005565694559e8]          WriteMemory32 #0x100000006, %17, %18, <unknown immediate type>
    // (uses: 0) [0000556569455a50] %20    = GetRegister r2 (uses: 1) [0000556569455ab8] %21    =
    // GetRegister r5 (uses: 1) [0000556569455b20] %22    = Add32 %21, %20, #0 (uses: 1)
    ...
    jit.Regs() = {0x2154abb5, 0xdbaa6333, 0xf8a7bc0e, 0x989f6096, 0x19cd7783, 0xe1cf5b7f,
                  0x9bb1aa6c, 0x6b700f5c, 0xc04f6cb2, 0xc8df07f0, 0x217d83de, 0xe77fdffa,
                  0x98bcceaf, 0xbfcab4f7, 0xdb9d5405, 0x00000000};
...
TEST_CASE("thumb: Opt Failure: Get/Set Elimination for Flags 2", "[thumb]") {
    ...
    jit.Regs() = {0x954d53b0, 0x4caaad40, 0xa42325b8, 0x0da0cdb6, 0x0f43507e, 0x31d68ae1,
                  0x9c471808, 0x892a6888, 0x3b9ffb23, 0x0a92ef93, 0x38dee619, 0xc0e95e81,
                  0x6a448690, 0xc2d4d6ad, 0xe93600b9, 0x00000000};
    jit.SetCpsr(0x000001f0); // Thumb, User-mode

    test_env.ticks_left = 7;
    CheckedRun([&]() { jit.Run(); });

    const std::array<u32, 16> expected = {0x954d53b0, 0x4caaad40, 0xb0afaead, 0x0da0cdb6,
                                          0x0f43507e, 0xb4b3b2b1, 0x00000066, 0x892a6888,
                                          0x3b9ffb23, 0x0a92ef93, 0x38dee619, 0xc0e95e81,
                                          0x6a448690, 0xc2d4d6b9, 0xe93600b9, 0x0000000a};
