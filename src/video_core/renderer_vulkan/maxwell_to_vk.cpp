...
#define SURFACE_FORMAT_LIST \
    SURFACE_FORMAT_ELEM(VK_FORMAT_B8G8R8A8_UNORM, usage_attachable | usage_storage, A8B8G8R8_UNORM) \
    SURFACE_FORMAT_ELEM(VK_FORMAT_B8G8R8A8_SNORM, usage_attachable | usage_storage, A8B8G8R8_SNORM) \
    SURFACE_FORMAT_ELEM(VK_FORMAT_B8G8R8A8_SINT, usage_attachable | usage_storage, A8B8G8R8_SINT) \
    SURFACE_FORMAT_ELEM(VK_FORMAT_B8G8R8A8_UINT, usage_attachable | usage_storage, A8B8G8R8_UINT) \
