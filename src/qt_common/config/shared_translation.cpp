...
#define INSERT(SETTINGS, ID, NAME, TOOLTIP)                                                        \
    ...
    INSERT(Settings, fast_cpu_time, tr("Fast CPU Time"),
    ...
    INSERT(Settings, max_anisotropy, tr("Anisotropic Filtering:"),
           tr("Controls the quality of texture rendering at oblique angles.\nSafe to set at 16x on "
              "most GPUs."));
    INSERT(Settings, gpu_accuracy, tr("GPU Accuracy:"),
           tr("Controls the GPU emulation accuracy.\nMost games render fine with Normal, but High "
              "is still "
    ...
    INSERT(Settings, use_asynchronous_shaders, tr("Enable asynchronous shader compilation (Hack)"),
           tr("May reduce shader stutter."));
    INSERT(Settings, use_fast_gpu_time, QString(), QString());
    INSERT(Settings, fast_gpu_time, tr("Fast GPU Time (Hack)"),
    ...
    INSERT(Settings, dyna_state, tr("Extended Dynamic State"),
           tr("Controls the number of features that can be used in Extended Dynamic State.\nHigher "
              "numbers allow for more features and can increase performance, but may cause "
    ...
    INSERT(
        Settings, sample_shading_fraction, tr("Sample Shading"),
