...
private:
    ...
    LRUCache<PatchCacheKey, PatchTextAddress> patch_cache{
    ...
    void BranchToPatch(uintptr_t module_dest) {
        if (patch_cache.isEnabled()) {
            ...
            LOG_DEBUG(Core_ARM, "LRU cache lookup for module={}, offset={:#x}",
                      fmt::ptr(module_id.data()), module_dest);
            ...
            LOG_DEBUG(Core_ARM, "LRU cache miss for module offset {:#x}, creating new patch",
                      module_dest);
