    ...
    struct System::Impl {
        explicit Impl(System &system)
            : kernel{system}, fs_controller{system}, hid_core{}, cpu_manager{system},
              reporter{system}, applet_manager{system}, frontend_applets{system},
              profile_manager{} /* remove early general channel init */ {
        }
        ...
        void LoadOverrides(u64 programId) const {
            ...
            if (programId == 0x010028600EBDA000 && vendor == "Mali") {
                // Mario 3d World
        ...
        void EnsureGeneralChannelInitialized(System &system) {
            ...
            general_channel_context = std::make_unique<
                Service::KernelHelpers::ServiceContext>(system, "GeneralChannel");
