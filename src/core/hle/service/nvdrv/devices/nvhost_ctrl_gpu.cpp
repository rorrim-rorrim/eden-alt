...
NvResult nvhost_ctrl_gpu::Ioctl1(DeviceFD fd, Ioctl command, std::span<const u8> input,
    ...
    std::string_view friendly_name = [raw = command.raw]() {
        ...
        case 0x0d:
            return "INVAL_ICACHE";
        case 0x0e:
            return "SET_MMU_DEBUG_MODE ";
        case 0x0f:
            return "SET_SM_DEBUG_MODE";
        case 0x10:
            return "WAIT_FOR_PAUSE";
        case 0x11:
            return "GET_TPC_EXCEPTION_EN_STATUS";
        case 0x12:
            return "NUM_VSMS";
        case 0x13:
            return "VSMS_MAPPING";
        case 0x14:
            return "ZBC_GET_ACTIVE_SLOT_MASK";
        case 0x15:
            return "PMU_GET_GPU_LOAD";
        case 0x16:
            return "SET_CG_CONTROLS";
        case 0x17:
            return "GET_CG_CONTROLS";
        case 0x18:
            return "SET_PG_CONTROLS";
        case 0x19:
            return "GET_PG_CONTROLS";
        case 0x1A:
            return "PMU_GET_ELPG_RESIDENCY_GATING";
        case 0x1B:
            return "GET_ERROR_CHANNEL_USER_DATA";
        case 0x1D:
            return "GET_CPU_TIME_CORRELATION_INFO";
        default:
            return "UNKNOWN";
        }
    }();
...
NvResult nvhost_ctrl_gpu::ZBCSetTable(IoctlZbcSetTable& params) {
    ...
    case ZBCTypes::color: {
        ...
        auto color_it =
            std::ranges::find_if(zbc_colors, [&](const ZbcColorEntry& color_in_question) {
    ...
    case ZBCTypes::depth: {
        ...
        auto depth_it =
            std::ranges::find_if(zbc_depths, [&](const ZbcDepthEntry& depth_entry_in_question) {
